...
def extract_info(text):
    ...
    date = f"{date_match.group(2)}-{date_match.group(1)}-{date_match.group(3)}" if date_match else "UnknownDate"
    limit = f"${limit_match.group(1).strip()}" if limit_match else "UnknownLimit"
